...
const Login = ({ onLogin }) => {
  ...
  // Demo login using Firebase Authentication
  const loginAsDemo = async (role) => {
    ...
    try {
      ...
      setError(`Demo login failed: ${error.message}. Please create this user in Firebase Console first.`);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="login-card">
        ...
        <div className="login-form-container">
          ...
          <div className="demo-login">
            ...
            <small>Click any button for instant access</small>
          </div>
        </div>
      </div>
    </div>
